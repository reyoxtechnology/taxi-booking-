...
import 'package:mycab_user/modules/drawer/drawer.dart';
import 'package:mycab_user/modules/home/MapPinSelectionView.dart';
import 'package:mycab_user/modules/home/request_view.dart';

import 'addressSelectionView.dart';
...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  final _londonLatLong = const LatLng(51.505939, -0.088727);
  ...
  //     for (var i = 0; i < 4; i++) {
  //       LatLng startPoint = i == 0 ? carPointOne[carOneIndex] : i == 1 ? carPointTwo[carTwoIndex] : i == 2 ? carPointThree[carThreeIndex] : carPointFour[carFourIndex];
  //       LatLng lastPoint = i == 0 ? carPointOne[carOneIndex - 1 == -1 ? carPointOne.length - 1 : carOneIndex - 1] : i == 1 ? carPointTwo[carTwoIndex - 1 == -1 ? carPointTwo.length - 1 : carTwoIndex - 1]
  //               : i == 2 ? carPointThree[carThreeIndex - 1 == -1 ? carPointThree.length - 1 : carThreeIndex - 1] : carPointFour[carFourIndex - 1 == -1 ? carPointFour.length - 1 : carFourIndex - 1];
  //       final MarkerId markerId2 = MarkerId('$i');
  //       final Marker marker2 = Marker(
  //           markerId: markerId2, position: startPoint,
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Positioned(
            top: 0, left: 0,
            right: 0, height: MediaQuery.of(context).size.height,
            child: GoogleMap(
